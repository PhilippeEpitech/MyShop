...
$products = json_decode(getProduct($id));
...
if (isset($_POST['valider'])) {
    ...
    if (isset($_POST['name']) && isset($_POST['price']) && isset($_POST['description']) && isset($_POST['image']) && isset($_POST['category'])) {
        if (!empty($_POST['name']) && !empty($_POST['price']) && !empty($_POST['description']) && !empty($_POST['image']) && !empty($_POST['category'])) {
            ...
            try {
                modifier($id, $name, $price, $desc, $img, $cat);
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" style="font-weight: bold;" aria-current="page" href="#">Modifier</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
               ...
               <form method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="image" value="<?= $img ?>" required>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Category: Chaussure=1 | Sweat-shirt=2 | Tee-shirt=3</label>
                        <input type="text" class="form-control" name="category" value="<?= $cat ?>" required>
                    </div>

                    <button type="submit" name="valider" class="btn btn-success">Ajouter le produit modifier</button>
                </form>
